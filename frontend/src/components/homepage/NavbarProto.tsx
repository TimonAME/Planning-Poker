...
export default function Navbar() {
    ...
    return (
        <nav className="relative px-4 py-4 flex justify-around items-center h-16">
            <Link to="#" className="text-3xl font-bold leading-none hidden md:block">
            ...
            <ul className="absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 flex mx-auto items-center w-auto space-x-6">
                ...
                <li>
                    <Link to="#" className="text-sm text-gray-400 hover:text-gray-500">Documentation</Link>
                </li>
                <li className="text-gray-300">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" className="w-4 h-4 current-fill" viewBox="0 0 24 24">
                        <path d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
                ...
                <li>
                    <Link to="#" className="text-sm text-gray-400 hover:text-gray-500">Settings</Link>
                </li>
            </ul>
            <div className="hidden md:block">
                <a className="inline-block py-2 px-6 bg-button hover:bg-buttonhover text-sm text-white font-bold rounded-xl transition duration-200" href="/">
                    Start Game
                </a>
            </div>
        </nav>
