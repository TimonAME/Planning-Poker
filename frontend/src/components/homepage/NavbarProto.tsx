...
export default function NavbarProto() {
    return (
        <>
            <nav className="relative px-4 py-4 flex justify-around items-center">
                ...
                <ul
                    className="absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 flex
                    mx-auto items-center w-auto space-x-6"
                >
                    <li>
                        <Link
                            to={"#"}
                    ...
                    <li className="text-gray-300">
                        ...
                        >
                            <path
                                d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0
